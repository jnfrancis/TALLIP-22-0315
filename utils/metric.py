...
def get_ner_fmeasure(golden_lists, predict_lists, label_type="BMES",printnum=False):
    # batch_size
...
def get_ner_BMES(label_list):
    ...
    whole_tag = ''
    index_tag = ''
    # 保存一个instance中所有非O的word对应的信息
    tag_list = []
    # 保存所有label和index的信息，每个元素如下：[3,6]PER
    stand_matrix = []
    # 遍历每一个char
